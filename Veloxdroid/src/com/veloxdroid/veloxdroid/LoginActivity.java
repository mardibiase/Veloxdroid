...
import com.veloxdroid.controller.UserLoginTask;
...
public class LoginActivity extends Activity {
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			mAuthTask.setmEmailView(mEmailView);
			mAuthTask.setmPasswordView(mPasswordView);
			mAuthTask.setSettings(getSharedPreferences(MainActivity.PREFS_NAME, 0));
